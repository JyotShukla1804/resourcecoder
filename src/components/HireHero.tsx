          ...
          <div className="lg:col-span-5 flex justify-center items-center relative w-full mt-10 lg:mt-0">
            <div className="relative w-full flex items-center justify-center">
              {(image === "/ReactJS Developer.svg" || image === "/ReactJS%20Developer.svg" || (dynamicTitle && dynamicTitle.toLowerCase().includes("react") && !dynamicTitle.toLowerCase().includes("native"))) ? (
                ...
                />
              ) : (image === "/NextJS Developer (1).svg" || image === "/NextJS%20Developer%20(1).svg" || (dynamicTitle && dynamicTitle.toLowerCase().includes("next"))) ? (
                <img
                  src="/NextJS Developer (1).svg"
                  alt="NextJS Developer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (image === "/AI Integration Developer.svg" || image === "/AI%20Integration%20Developer.svg" || (dynamicTitle && dynamicTitle.toLowerCase().includes("ai integration"))) ? (
                <img
                  src="/AI%20Integration%20Developer.svg"
                  alt="AI Integration Developer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (image === "/LLM Developer.svg" || image === "/LLM%20Developer.svg" || (dynamicTitle && (dynamicTitle.toLowerCase().includes("generative ai") || dynamicTitle.toLowerCase().includes("llm")))) ? (
                <img
                  src="/LLM Developer.svg"
                  alt="LLM/Generative AI Developer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
                ...
                <img
                  src="/Mern Stack Developer-1.svg"
                ...
                <img
                  src="/Javascript%20Developer.svg"
                ...
                <img
                  src="/React%20Native%20Developer.svg"
                  alt="React Native Developer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (dynamicTitle && dynamicTitle.toLowerCase().includes("flutter")) ? (
                <img
                  src="/Flutter%20Developer.svg"
                  alt="Flutter Developer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (dynamicTitle && dynamicTitle.toLowerCase().includes("ios")) ? (
                <img
                  src="/IOS%20Developer.svg"
                  alt="iOS Developer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (dynamicTitle && dynamicTitle.toLowerCase().includes("android")) ? (
                <img
                  src="/Android%20Developer.svg"
                  alt="Android Developer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (image === "/engineer.svg" || (dynamicTitle && (dynamicTitle.toLowerCase().includes("ai/ml") || dynamicTitle.toLowerCase().includes("ai / ml") || dynamicTitle.toLowerCase().includes("machine learning") || dynamicTitle.toLowerCase().includes("artificial intelligence")))) ? (
                <img
                  src="/engineer.svg"
                  alt="AI/ML Developer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (image === "/Data Engineer.svg" || image === "/Data%20Engineer.svg" || (dynamicTitle && dynamicTitle.toLowerCase().includes("data engineer"))) ? (
                <img
                  src="/Data Engineer.svg"
                  alt="Data Engineer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (image === "/Data Scientist.svg" || image === "/Data%20Scientist.svg" || (dynamicTitle && dynamicTitle.toLowerCase().includes("data scientist"))) ? (
                <img
                  src="/Data Scientist.svg"
                  alt="Data Scientist Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (image === "/DevOps Engineer.svg" || image === "/DevOps%20Engineer.svg" || (dynamicTitle && (dynamicTitle.toLowerCase().includes("devops") || dynamicTitle.toLowerCase().includes("dev ops")))) ? (
                <img
                  src="/DevOps Engineer.svg"
                  alt="DevOps Engineer Workspace"
                  className="max-w-full h-auto drop-shadow-2xl rounded-[19px] md:rounded-[27px] hover:-translate-y-2 transition-transform duration-500"
                />
              ) : (image === "/Cloud Engineer.svg" || image === "/Cloud%20Engineer.svg" || (dynamicTitle && dynamicTitle.toLowerCase().includes("cloud engineer"))) ? (
                <img
                  src="/Cloud Engineer.svg"
