        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
              We Guarantee <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Measurable Outcomes.</span>
            </h2>
            ...
            <div className="pt-4">
               <button className="text-sm font-bold text-blue-600 hover:text-blue-500 flex items-center gap-2 group transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative">
            ...
            {outcomes.map((outcome, idx) => (
              <div 
                key={idx} 
                className={`bg-slate-50 border border-slate-200 p-8 rounded-2xl hover:bg-white transition-all hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(59,130,246,0.1)] ${idx % 2 === 1 ? 'sm:mt-12' : ''}`}
              >
                <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-6 border border-blue-200">
                  {outcome.icon}
                </div>
