...
export function AwardsTeam() {
  ...
  const tabs = [
    {
      id: "engineers",
      label: "World Class Technology Experts",
      icon: <Code className="w-5 h-5" />,
      title: "Expert Team. Innovative Solutions.",
      description: "At Krazio Cloud, our team brings together experienced software engineers, AI specialists, AR/VR/XR experts, UI/UX designers, QA professionals, and technology consultants who are passionate about building future ready digital solutions. Whether you need a dedicated development team or end to end project delivery, we provide the expertise and innovation to turn your vision into reality.",
    ...
    },
    {
      ...
      title: "Leadership That Inspires Innovation",
