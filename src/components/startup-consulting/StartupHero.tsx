    ...
    <section className="w-full relative overflow-hidden flex items-center min-h-[90vh] bg-[#f8f9ff]">
      ...
      <div className="max-w-[1358px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-48 pb-24 text-center">
        ...
        >
          ...
          <span className="text-sm font-bold tracking-[0.15em] text-[#4B56D2] uppercase">Krazio Cloud Enterprise</span>
        </motion.div>
        ...
        >
          Partner with Krazio Cloud to accelerate your digital transformation journey. From strategy and design to development and deployment, our experts deliver secure, scalable, and future ready technology solutions tailored to your business goals.
        </motion.p>
