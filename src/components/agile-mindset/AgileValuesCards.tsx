        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-[#4B56D2]/10 flex items-center justify-center text-[#4B56D2] mb-8 group-hover:scale-110 transition-transform duration-300 border border-[#4B56D2]/20">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-md flex items-center justify-center text-white mb-8 shadow-xl border border-white/20 group-hover:scale-110 transition-transform duration-300">
