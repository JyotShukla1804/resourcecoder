      ...
      <div className="max-w-[1358px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-3/5 space-y-8">
          ...
          >
            ...
            <span className="text-xs font-semibold text-white tracking-wider uppercase">Accelerate Digital Transformation</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-cyan-200">Digital Success</span>
          </motion.h2>
          ...
          >
            Leverage Krazio Cloud's expertise in AI, immersive technologies, and custom software development to build secure, scalable, and innovative solutions that drive business growth and long-term success.
          </motion.p>
        ...
        >
          <div className="relative w-full max-w-[388px] aspect-[388/259] shadow-2xl rounded-[20px] overflow-hidden border border-white/20">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent flex flex-col justify-end p-6">
              <h3 className="text-white font-bold text-xl leading-tight mb-2">Accelerate Digital Transformation</h3>
