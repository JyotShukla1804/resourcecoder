...
const hireTeamCategories = [
    { title: "Frontend", roles: ["React.js Developer", "Next.js Developer", "Angular Developer", "Vue.js Developer", "Frontend Developer", "UI/UX Designer"] },
    { title: "Backend", roles: ["Node.js Developer", "Python Developer", "Java Developer", ".NET Developer", "PHP / Laravel Developer", "Golang Developer"] },
    { title: "Full-Stack", roles: ["Full-Stack Developer", "MERN Stack Developer", "MEAN Stack Developer", "JavaScript Developer", "TypeScript Developer"] },
    { title: "Mobile", roles: ["React Native Developer", "Flutter Developer", "iOS Developer", "Android Developer"] },
    { title: "AI, Data & Cloud", roles: ["AI/ML Engineer", "Generative AI / LLM Developer", "AI Integration Developer", "Data Engineer", "Data Scientist", "DevOps Engineer", "Cloud Engineer (AWS / Azure / GCP)"] },
    { title: "CMS, E-commerce & QA", roles: ["WordPress Developer", "Shopify Developer", "WooCommerce Developer", "QA / Automation Engineer", "Cybersecurity / DevSecOps Engineer", "Blockchain Developer"] }
];

const generateRoleSlug = (role) => {
    return role.replace(/^Hire /, '').toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '');
};

const getRoleName = (role) => {
    return role.replace(/^Hire /, '');
};
...
async function seed() {
    ...
    for (const role of allRoles) {
        ...
        const content = {
            "blocks": [
                {
                    "type": "hero",
                    "title": `Hire Dedicated <br/><span class='bg-gradient-to-r from-[#4B56D2] to-[#4B56D2] bg-clip-text text-transparent'>${name}s</span>`,
                    "subtitle": `Build blazing-fast, scalable, and interactive applications with our pre-vetted ${name} experts.`,
                    "description": `Scale your engineering capabilities instantly. Hire a dedicated ${name} as a full-time extension of your team, working in your time zone with zero recruitment overhead—saving you up to 60% compared to local hiring.`,
                    "primaryCta": `Hire ${name}`,
                ...
                {
                    "type": "benefits",
                    "title": `Why Hire a Dedicated ${name} Through ResourceCoder`,
                ...
                {
                    "type": "services",
                    "title": `What Our ${name}s Can Build For You`,
                    ...
                    "items": [
                        ...
                        { "icon": "react", "name": "Performance Optimization", "description": `Comprehensive code audits, refactoring, and performance tuning to ensure your ${name} infrastructure runs flawlessly.` },
                ...
                },
                {
                    ...
                    "subtitle": `Our ${name}s are masters of the modern software ecosystem.`,
                    "items": [
                    ...
                    "plans": [
                        {
                            ...
                            "description": `A full-time ${name} dedicated solely to your projects, acting as a direct extension of your team.`,
                ...
                },
                {
                    "type": "faqs",
                    "items": [
                        { "question": `How much does it cost to hire a ${name}?`, "answer": "Pricing depends on the developer's seniority level, but our flat monthly fee model consistently saves global clients 40-60% compared to local onshore hiring, with zero hidden recruitment overhead." },
        ...
        const seo = {
            "keywords": `Hire ${name}, ${name} developer, dedicated ${name}`,
            "metaTitle": `Hire Dedicated ${name}s | ResourceCoder`,
            "metaDescription": `Hire pre-vetted ${name}s on a flexible monthly model. Save up to 60% with dedicated talent, time-zone overlap, and zero recruitment overhead.`
        };
    ...
    console.log("Done seeding detailed pages!");
}
